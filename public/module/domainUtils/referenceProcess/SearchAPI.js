...
import { sendErrorLog, redirectToErrorPage , hideCollapse, makeParentDivEmpty, appendSearchResults, setSelectedDomainIdAndName, setSelectedTagIdAndName } from "@index/index.js";
        ...
        timeout = setTimeout(() => {
            ...
            .then((res) => {
                ...
                if(res.length <= 0){
                    ...
                    appendSearchResults(res, ".domain_search_results_container", "domain_search_container_result")
                    const results           = document.querySelectorAll(".domain_search_container_result")
...
export const fetchTagData = (copy_tag)=>{
    // 検索フォームで入力された値
    ...
    search_input_field.addEventListener("input", ()=>{
        ...
        timeout = setTimeout(() => {
            ...
            .then((res) => {
                ...
                appendSearchResults(uniqueArray, ".tag_search_results_container", "tag_search_container_result")
                const results = document.querySelectorAll(".tag_search_container_result")
                    // 検索結果で表示したなにかしらをせんたくしたときの処理
                    results.forEach((result)=>{
                        result.addEventListener("click", (e)=>{
