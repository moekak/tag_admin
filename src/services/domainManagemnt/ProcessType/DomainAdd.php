...
class DomainAdd implements DomainProcessBase{
    ...
    public function formValidator(){
        ...
        if($_POST["domain_type"] !== "directory"){
            FormValidation::isDomainExisted(intval($_POST["domain_id"]), "create");
        }
    ...
    public function submissionProcess(){
        $this->formValidator();
        $this->instancce->getInstance()->submissionProcessWithAdd();
        SystemFeedback::showSuccessMsg(SUCCESS_ADD_DOMAIN, PATH . "index", "index");
        return;
    }
